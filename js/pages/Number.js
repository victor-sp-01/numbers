...
const Number =()=>{
    ...
    const { limitRange = 1000 , limitCasillas = 10 } = JSON.parse(getLocalStorage( 'DataNumber', '[{}]' ))  
    ...
    const pushNumer =( target )=>{
        ...
        target.value = Element.number.value
    ...
    const Element = $Element.findChildren( '.form__sKQFM' ) //Element.querySelector( '.form__sKQFM' ) 
